...
ScrollViewBase {
    ...
    property bool unsavedChanges: pricing2.unsavedChanges
                                  || pricing.unsavedChanges
    ...
    viewActions: ViewActionButton {
        ...
        InfoDialog {
            ...
            StandardButton {
                ...
                onClicked: machineControlService.call("deleteMachine", {
                                                          "deviceID": model.uuid
                                                      }, deleteCallback)
    ...
    Column {
        ...
        Flow {
            ...
            SwitchSetupContainer {
                ...
                deviceID: !model
                          || docroot.deviceID !== "" ? docroot.deviceID : model.uuid
            }
